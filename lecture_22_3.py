...
def create_clubs(symbol):
    ...
    triangle = Polygon(Point(0, 0), Point(-RADIUS * 2, RADIUS * 3), Point(RADIUS * 2, RADIUS * 3))
...
def create_hearts(symbol):
    ...
    triangle = Polygon(Point(-RADIUS * 2, -RADIUS), Point(RADIUS * 2, -RADIUS), Point(0, RADIUS * 2))
...
def create_spades(symbol):
    ...
    triangle1 = Polygon(Point(-RADIUS * 2, RADIUS), Point(RADIUS * 2, RADIUS), Point(0, -RADIUS * 2))
    triangle1.setFillColor("black")
    triangle1.setBorderWidth(0)
    symbol.add(triangle1)

    triangle2 = Polygon(Point(0, 0), Point(-RADIUS * 2, RADIUS * 4), Point(RADIUS * 2, RADIUS * 4))
...
class Table(object):
    ...
    def __init__(self):
        ...
        self.message.moveTo(self.canvas.getWidth() / 2 - dim[0] / 2, self.canvas.getHeight() - 80)
        ...
        self.question.moveTo(self.canvas.getWidth() / 2 - dim[0] / 2, self.canvas.getHeight() - 40)
